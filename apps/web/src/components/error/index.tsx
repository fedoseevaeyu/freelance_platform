      ...
      return (
        <div className="flex h-[calc(100vh-80px)] w-full items-center justify-center p-5 ">
          <MetaTags
            ...
            description="Что-то пошло не так. Попробуйте обновить эту страницу или свяжитесь с нами, если проблема сохраняется."
          />
          <div className="text-center">
            ...
            <p className="mt-5 text-slate-600 lg:text-lg">
              Что-то пошло не так. Попробуйте обновить эту страницу или
              свяжитесь с нами, если проблема сохраняется.
            </p>
          </div>
        </div>
      );
